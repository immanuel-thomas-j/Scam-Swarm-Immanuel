          ...
          {swarmPayload && (
            <div className="results-container animate-flicker">
              ...
              <div className="export-bar">
                ...
                <button className="export-btn secondary" onClick={() => window.print()} style={{ display: 'flex', alignItems: 'center', gap: '8px', justifyContent: 'center' }}>
                  <EyeIcon size={14} /> Print Report
                </button>
